...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            <button type="button" class="btn btn-sm btn-primary" onclick="window.location.href='{{ url('kategori/export_pdf') }}'">Export PDF</button>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group form-group-sm row text-sm mb-0">
                        <label for="filter_date" class="col-md-1 col-form-label">
                            Filter
                        </label>
